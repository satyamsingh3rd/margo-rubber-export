        ...
        {hasBody ? (
          ...
          <div className="rounded-card border-line border-l-accent-400 mb-16 max-w-[68ch] border border-l-2 bg-[#0B0D10] p-7 md:p-9">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="bg-accent-400 text-canvas hover:bg-accent-300 shadow-glow rounded-pill inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold transition-colors"
              >
                Ask our engineers
              </Link>
              <Link
